...
NEXT_BOX_X_PADDING = 30
NEXT_BOX_X = 575 + NEXT_BOX_X_PADDING
NEXT_BOX_Y = DIS_Y/2 - (NEXT_BOX_HEIGHT/2) -50
NEXT_BOX_RECT = (NEXT_BOX_X, NEXT_BOX_Y, NEXT_BOX_WIDTH, NEXT_BOX_HEIGHT)
RNSCALE = 20 #rounded next box scale
ROUND_NEXT_BOX_RECT = (NEXT_BOX_X-RNSCALE, NEXT_BOX_Y-RNSCALE,
                      NEXT_BOX_WIDTH+(2*RNSCALE), NEXT_BOX_HEIGHT+(2*RNSCALE))
'''NEXT_BOX_TEXT'''
NEXT_TEXT_SIZE = 50
...
RSSCALE = 20 #scale used to make roudned box
ROUND_STAT_BOX_RECT = (STAT_BOX_X-RSSCALE, STAT_BOX_Y-RSSCALE,
                      STAT_BOX_WIDTH+(2*RSSCALE), STAT_BOX_HEIGHT+(2*RSSCALE))
...
RLSCALE = 10
ROUND_LINE_BOX_RECT = (LINE_BOX_X-RLSCALE, LINE_BOX_Y-RLSCALE,
                      LINE_BOX_WIDTH+(2*RLSCALE), LINE_BOX_HEIGHT+(2*RLSCALE))
LINE_TEXT_X = (LINE_BOX_X) + (LINE_BOX_WIDTH/2)
LINE_TEXT_Y = LINE_BOX_Y
LINE_TEXT_COORD = (LINE_TEXT_X, (LINE_TEXT_Y+LINE_BOX_HEIGHT)/2 + RLSCALE)
